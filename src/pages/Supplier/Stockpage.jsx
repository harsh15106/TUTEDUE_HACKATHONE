...
const Stockpage = () => {
    ...
    const handleDeleteItem = (itemId) => {
        // A confirmation step is recommended here in a real app
                        ...
                        <tbody>
                            {stockItems.map((item, index) => (
                                <tr key={item.id}>
                                    ...
                                    <td>{item.rate}</td>
                                    <td>
                                        <button className="btn-update" onClick={() => handleOpenModal(item)}> <img src="/public/edit.svg" alt="edit" /> </button>
                                        <button className="btn-delete" onClick={() => handleDeleteItem(item.id)}><img src="/public/delete.svg" alt="delete" /></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
